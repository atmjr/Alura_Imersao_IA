...
O objetivo é enviar uma imagem de um documento para a API e obter um json com os dados obtidos, esses dados poderão ser utilizados para um registro/entrada automatizada desse documento na nossa aplicação. Hoje esse registro é realizado manualmente no sistema. 
